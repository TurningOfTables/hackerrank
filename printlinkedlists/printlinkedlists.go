...
/*
 * HackerRank URL: https://www.hackerrank.com/challenges/print-the-elements-of-a-linked-list/
 *
/
...
// printLinkedList traverses a SingleLinkedList structure and prints the data of each node
// returns when head pointer is null
